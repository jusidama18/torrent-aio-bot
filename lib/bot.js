...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  bot.sendMessage(msg.from.id, "*Click link below to get access to Our Google Drive link\nby Join Team Drive and after that you can see in your\n Google Drive _Shared Drives_ and our Drive named with\n Torrent Bot\n\nSo please don't spam request access pleease 😬*", opts);
  });
////////////////////////////////////////// All Callbacks/////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    try {
      ...
      bot.sendMessage(chatId, `🗂 Google Drive Link : ${driveLink}\nPublic link: ${publicLink}`);
      bot.sendMessage(chatId, `🗂 Drive Index Link : https://torrent.juicedama.workers.dev/0:/${fileName}`);
    } catch (e) {
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    const onDriveUpload = (torr, url) => bot.sendMessage(from, `Uploaded Successfully to Google Drive 📤\n\n${url}\n\n🗂 Drive Index : https://torrent.juicedama.workers.dev/0:/${torr.name}`);
  ...
  bot.onText(statusRegex, (msg, match) => {
    ...
    if (link.indexOf("magnet:") !== 0) {
      ...
      if (!torr.done) {
        ...
        mess1 += `Downloading 📥 : ${torr.progress}%\n\n`;
        mess1 += `Time Remaining 🕔 : ${torr.redableTimeRemaining}\n\n`;
        mess1 += `⚡️ If Upload Successful ,Your Download link will appear below 👇🏻\n\n`;
      } else {
        mess1 += `♨️ Please /donate any Amount you Wish to keep this Service Alive! 😇`
      }
  ...
  bot.onText(removeRegex, (msg, match) => {
    ...
    try {
      torrent.remove(link);
      bot.sendMessage(from, "Magnet Removed Successfully ♻️");
    } catch (e) {
