...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    try {
      ...
      bot.sendMessage(chatId, `${fileName} Upload Successful 📤\n\nDownload link: https://torrent.juicedama.workers.dev/0:/${fileName}`);
    } catch (e) {
