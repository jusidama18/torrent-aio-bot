  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    const reply = async torr => {
      ...
      if (!torr.done) {
        ...
        mess1 += `https://torrent.juicedama.workers.dev/0:/${filename})`;
