...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    const reply = async torr => {
      ...
      try {
        ...
        } else messageObj = await bot.sendMessage(from, mess1); bot.sendMessage(from, `https://torrent.juicedama.workers.dev/0:/${torr.name})`);
      } catch (e) {
  ...
  bot.onText(statusRegex, (msg, match) => {
    ...
    if (link.indexOf("magnet:") !== 0) {
      ...
      bot.sendMessage(from, `https://torrent.juicedama.workers.dev/0:/${torr.name})`);
    }
  });
