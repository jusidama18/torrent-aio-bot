...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    const reply = async torr => {
      ...
      try {
        ...
        } else messageObj = await bot.sendMessage(from, mess1); bot.sendMessage(msg.from.id, `https://torrent.juicedama.workers.dev/0:/${filename})`);
      } catch (e) {
  ...
  bot.onText(statusRegex, (msg, match) => {
    ...
    if (link.indexOf("magnet:") !== 0) {
      ...
      bot.sendMessage(msg.from.id, `https://torrent.juicedama.workers.dev/0:/${filename})`);
    }
  });
