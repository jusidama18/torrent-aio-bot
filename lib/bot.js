...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  bot.sendMessage(msg.from.id, "*Click link below to get access to Our Google Drive link by Join Team Drive and after that you can see in your Google Drive Shared Drives and our Drive named with Torrent Bot\n\nSo please don't spam request access pleease 😬*", opts);
  });
////////////////////////////////////////// All Callbacks/////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    const onDriveUploadStart = torr => bot.sendMessage(from, `📤 Uploading ${torr.name} to Google Drive, click /drive to access your link`);
